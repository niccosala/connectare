...
<head>
	...
	<title>Connectare</title>

  <meta name="theme-color" content="white">
  <meta name="viewport" content="width=device-width, user-scalable=no, initial-scale=1.0, minimum-scale=1.0, maximum-scale=1.0">
	<link rel="stylesheet" href="style/m.generale.css">
	<link rel="stylesheet" href="style/m.home.css">
  <link rel="shortcut icon" href="images/icon.png">
	<script src="script/m.home.js"></script>
...
<body>
    ...
    <div class="show" style="background: url('images/imm1.jpeg') no-repeat fixed; background-size: cover; background-position: center;">
      <div id="container">
        <div id="question">
	    ...
	    <video id="video" controls onended="end()">
	      <source src="videos/CONNECTARE_TELA.mov" type="video/mp4">
	      <source src="videos/CONNECTARE_TELA.mov" type="video/ogg">
    ...
    <div id="call" onclick="location.href='m.contatti.php'">
      	&#9742;
    </div>


	<div class="section" style="background: url('images/imm2.jpeg') no-repeat fixed; background-size: 220%; background-position: center top;">
    ...
    <div class="section" style="background: url('images/imm3.jpeg') no-repeat fixed; background-size: 175%; background-position: center top;">
  	...
  	<div class="section"  style="background: url('images/imm4.jpeg') no-repeat fixed; background-size: 230%; background-position: center top;">
